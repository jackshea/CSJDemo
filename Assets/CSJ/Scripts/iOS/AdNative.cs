...
namespace ByteDance.Union
{
    ...
    public sealed class AdNative
    {
        ...
        /// specify timeout.
        /// </summary>
        public BUSplashAd LoadExpressSplashAd_iOS(
            AdSlot adSlot, ISplashAdListener listener, int timeOut, bool callbackOnMainThread = true)
        {
            return BUSplashAd.LoadSplashAd(adSlot, listener, timeOut, callbackOnMainThread);
        }

        /// <summary>
        /// Load the splash Ad asynchronously and notice on listener.
        /// </summary>
        public BUSplashAd LoadExpressSplashAd_iOS(AdSlot adSlot, ISplashAdListener listener, bool callbackOnMainThread = true)
        {
            return BUSplashAd.LoadSplashAd(adSlot, listener, -1, callbackOnMainThread);
        }
